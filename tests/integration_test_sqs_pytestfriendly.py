...
def test_end_to_end_sqs_pipeline():
    ...
    # return 0
    assert ok, f"Integration test FAILED. Item found: {found}. Q count: {queue_attrs}. DLQ count: {dlq_attrs}."

# Delete the following block as it prevents Pytest from running the test directly:
